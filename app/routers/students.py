...
@router.get("/{student_id}", response_model=schemas.StudentOut, summary="Get student by ID")
...
@router.put("/{student_id}", response_model=schemas.StudentOut, summary="Update student")
